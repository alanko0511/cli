...
var require_fsevents = __commonJS({
  "../../node_modules/.pnpm/fsevents@2.3.3/node_modules/fsevents/fsevents.js"(exports) {
    ...
    var Native = __require("./fsevents-X6WP4TKM.node"), events = Native.constants;
    function watch(path, since, handler) {
      if (typeof path != "string")
        throw new TypeError(`fsevents argument 1 must be a string and not a ${typeof path}`);
      if (typeof since == "function" && typeof handler > "u" && (handler = since, since = Native.flags.SinceNow), typeof since != "number")
      ...
      return () => {
        let result = instance ? Promise.resolve(instance).then(Native.stop) : Promise.resolve(void 0);
        return instance = void 0, result;
      };
    }
    ...
    function getFileType(flags) {
      ...
      if (events.ItemIsDir & flags || events.MustScanSubDirs & flags) return "directory";
    ...
    function getEventType(flags) {
      return events.ItemRemoved & flags ? "deleted" : events.ItemRenamed & flags ? "moved" : events.ItemCreated & flags ? "created" : events.ItemModified & flags ? "modified" : events.RootChanged & flags ? "root-changed" : events.ItemCloned & flags ? "cloned" : anyIsTrue(flags) ? "modified" : "unknown";
    }
...
//# sourceMappingURL=chokidar-K4QK4KVD.js.map
