...
const appCommands = Object.keys(AppCommands);
appCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    AppCommands[command].customPluginName = '@shopify/app';
});
const themeCommands = Object.keys(ThemeCommands);
themeCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    ThemeCommands[command].customPluginName = '@shopify/theme';
});
const hydrogenCommands = Object.keys(HydrogenCommands);
hydrogenCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    HydrogenCommands[command].customPluginName = '@shopify/cli-hydrogen';
});
const pluginCommandsCommands = Object.keys(PluginCommandsCommands);
pluginCommandsCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    PluginCommandsCommands[command].customPluginName = '@oclif/plugin-commands';
});
const didYouMeanCommands = Object.keys(DidYouMeanCommands);
didYouMeanCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    DidYouMeanCommands[command].customPluginName = '@shopify/plugin-did-you-mean';
});
const pluginPluginsCommands = Object.keys(PluginPluginsCommands);
pluginPluginsCommands.forEach((command) => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ;
    PluginPluginsCommands[command].customPluginName = '@oclif/plugin-plugins';
});
// eslint-disable-next-line @typescript-eslint/no-explicit-any
